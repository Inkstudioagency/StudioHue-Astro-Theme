...
| `Footer`             | `page` (PageKey)                                      | Newsletter form, 4 link columns, bottom links, wordmark. |
...
These are Webflow widgets driven by `public/js/interactions.js` and need their `data-*` attributes
